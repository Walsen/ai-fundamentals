...
SYSTEM_PROMPT = """You are an AWS Solution Arquitect. You help users design and build
well-architected solutions on AWS. Use the available tools to provide accurate up-to-date,
guidance on AWS services, architecture patterns, and pricing. When users asks about costs,
...
with aws_knowledge, aws_pricing:
    tools = aws_knowledge.list_tools_sync() + aws_pricing.list_tools_sync()
